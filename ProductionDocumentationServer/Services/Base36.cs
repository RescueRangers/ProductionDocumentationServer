...
namespace ProductionDocumentationServer.Services
{
	...
	internal class InvalidBase36DigitValueException : Exception
	{
		...
		protected InvalidBase36DigitValueException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
	...
	internal class InvalidBase36DigitException : Exception
	{
		...
		protected InvalidBase36DigitException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}

	[Serializable]
	internal class InvalidBase36ValueException : Exception
	{
		private long numericValue;
		...
		protected InvalidBase36ValueException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}

	[Serializable]
	internal class InvalidBase36NumberException : Exception
	{
		...
		protected InvalidBase36NumberException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}
